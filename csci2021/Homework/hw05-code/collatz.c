// collatz.c: "Optimized" version of collatz computation using bitwise
// operations in place of arithmetic operations. Portions of the code
// marked with letters should be described to explain their arithmetic
// equivalent.
