// phase03.c: mock phase03 from puzzlebox.c with a fixed hash
// code. Use GDB and knoweldge of how bit-wise operations like shifts,
// ors, xors work to gain insight on solvin the Project 2's puzzlebox.
