...
int main()
{
    ...
    /*ducks.push_back(*/Canvasback(std::string("CanvasBack"), 5.8f, 2.7d)/*/)*/;
    /*ducks.push_back(*/Duck(std::string("Loon"), 10.0f, 10.0d)/*/)*/;
    /*ducks.push_back(*/Mallard(std::string("Mallard"), 7.6f, 2.5d)/*/)*/;

    Rubber("The best Kind of Duck", 1000.0f, 10.0d);
