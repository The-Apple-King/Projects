...
public class simulator {
    ...
    public simulator() {
        ...
        lossprob= (float) 0.2; // probability that a packet is dropped .02 originally
        corruptprob= (float) 0.2; // probability that one bit is packet is flipped .02 originally
