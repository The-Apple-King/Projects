...
struct stmt *parse_line(struct interp *interp_p, const char *p,
    ...
    } else if (scan_line(interp_p,p,"if %e_<0_%e then goto %d",res,&err_pos) ||
	       scan_line(interp_p,p,"if %e_<=1_%e then goto %d",res,&err_pos)||
	       scan_line(interp_p,p,"if %e_>2_%e then goto %d",res,&err_pos) ||
	       scan_line(interp_p,p,"if %e_>=3_%e then goto %d",res,&err_pos)||
	       scan_line(interp_p,p,"if %e_==4_%e then goto %d",res,&err_pos)||
	       scan_line(interp_p,p,"if %e_<>5_%e then goto %d",res,&err_pos)){
