...
// Dragons move using euler integration based on a specified
// velocity and direction.
/**
 * @class Dragon
 * @brief Represents a Dragon in a physical system. Dragons move using euler
...
class Dragon : public IEntity {
 public:
  ...
  /**
   * @brief Gets the availability of the Dragon
   * @return The availability of the Dragon
   */
